...
class WidgetPostCommentBar extends StatelessWidget {
  ...
  const WidgetPostCommentBar({super.key, required this.post});
  @override
  Widget build(BuildContext context) {
    final postLikeController = Get.put(PostLikeController(postId: post.postId));
    final postCommentController = Get.put(PostCommentController(postId: post.postId));
    Widget commentsBar() {
            ...
            children: [
                  ...
                  Obx(() {
                    return GestureDetector(
                      ...
                      child: Icon(
                        ...
                        color: postLikeController.isLiked.value ? Color(0xFFE01D1D) : Color(0xFFB0B0B0),
                      ),
                    );
                  }),
                  SizedBox(width: 4),
              ...
              Row(
                children: [
                  ...
                  Obx(
                    () => Text(
                      postCommentController.commentCount.value.toString(),
                      style: commentStyle,
                    ),
                  ),
                ],
