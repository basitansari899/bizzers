import 'package:bizconnect/screens/learning/core/utils/size_utils.dart';
...
class CustomBottomBar extends StatelessWidget {
  ...
  List<BottomMenuModel> bottomMenuList = [
    ...
    BottomMenuModel(
      ...
      activeIcon: PrefUtils().getThemeData() == "primary"
          ? ImageConstant.imgNavMyCoursesActive
    ...
    BottomMenuModel(
      ...
      activeIcon: PrefUtils().getThemeData() == "primary"
          ? ImageConstant.imgNavChatActive
          : ImageConstant.imgNavChatActiveDark,
      title: "lbl_chat".tr,
